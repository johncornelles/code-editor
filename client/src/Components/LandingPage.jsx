          ...
          <div>
            ...
            {showMore &&(
              ...
              <div className='relative mt-20'>
                <img className='mt-20 w-full h-auto' src={boy} alt="boy" />
                <div className='absolute top-10 left-0  text-white border border-transparent bg-gray-500 rounded-lg h-40 w-80 items-center'>
                  <p>Top 10 Tips for Efficient Coding</p>
                  <p>Discover the best practices and tips to enhance your coding efficiency...</p>
                  <button className='border border-transparent h-6 w-20 rounded-lg bg-gray-400'>Read more</button>
                </div>
                <div  className='absolute left-0 bottom-28 text-white border border-transparent bg-gray-500 rounded-lg h-40 w-80 items-center'>
                  <p>How to Collaborate Effectively in a Remote Team</p>
                  <p>Learn how to maintain productivity and collaboration in a remote working environment...</p>
                  <button className='border border-transparent h-6 w-20 rounded-lg bg-gray-400'>Read more</button>
                </div>
                <div className='absolute right-0 bottom-28 text-white border border-transparent bg-gray-500 rounded-lg h-40 w-80 items-center'>
                  <p>The Future of Code Editors</p>
                  <p>Explore the latest trends and predictions for the future of code editors...</p>
                  <button className='border border-transparent h-6 w-20 rounded-lg bg-gray-400'>Read more</button>
                </div>
              </div>
